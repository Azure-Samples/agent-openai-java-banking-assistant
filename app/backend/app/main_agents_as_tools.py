...
from routers import auth_routers, chat_routers_agents_as_tools, content_routers
...
from config.container_azure_chat import Container
...
def create_app() -> FastAPI:
    ...
    container.wire(modules=[chat_routers_agents_as_tools,content_routers])
    ...
    app.include_router(chat_routers_agents_as_tools.router, prefix="/api", tags=["chat"])
