...
import com.microsoft.openai.samples.assistant.springai.tools.InvoiceScanTool;
...
public class PaymentMCPAgent extends MCPToolAgent {
    ...
    public PaymentMCPAgent(ChatModel chatModel, DocumentIntelligenceInvoiceScanHelper documentIntelligenceInvoiceScanHelper, String loggedUserName, String transactionMCPServerURL, String accountMCPServerUrl, String paymentsMCPServerUrl) {
        ...
        PromptTemplate promptTemplate = PromptTemplate.builder()
                .template(PAYMENT_AGENT_SYSTEM_MESSAGE)
                .build();
        var datetimeIso8601 = ZonedDateTime.now(ZoneId.of("UTC"))
                .toInstant()
                .toString();
    ...
    protected void extendToolMap(DocumentIntelligenceInvoiceScanHelper documentIntelligenceInvoiceScanHelper) {
        try {
            ...
            this.toolSpecifications.addAll(List.of(ToolCallbacks.from(invoiceScanTool)));
