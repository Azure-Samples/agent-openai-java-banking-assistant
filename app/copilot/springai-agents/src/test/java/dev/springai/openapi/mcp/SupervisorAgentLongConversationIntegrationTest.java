...
public class SupervisorAgentLongConversationIntegrationTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        chatHistory.add(new UserMessage("How much money do I have in my account?"));
        System.out.println(chatHistory.get(chatHistory.size() - 1));
        supervisorAgent.invoke(chatHistory);
        System.out.println(chatHistory.get(chatHistory.size() - 1));

        chatHistory.add(new UserMessage("what about my visa"));
        System.out.println(chatHistory.get(chatHistory.size() - 1));
        supervisorAgent.invoke(chatHistory);
        System.out.println(chatHistory.get(chatHistory.size() - 1));

        chatHistory.add(new UserMessage("When was last time I've paid contoso?"));
        System.out.println(chatHistory.get(chatHistory.size() - 1));
        supervisorAgent.invoke(chatHistory);
        System.out.println(chatHistory.get(chatHistory.size() - 1));

        chatHistory.add(new UserMessage("Please pay this bill gori.png"));
        ...
        chatHistory.add(new UserMessage("yep, they are correct"));
        System.out.println(chatHistory.get(chatHistory.size() - 1));
        supervisorAgent.invoke(chatHistory);
        System.out.println(chatHistory.get(chatHistory.size() - 1));


        chatHistory.add(new UserMessage("use my visa"));
        System.out.println(chatHistory.get(chatHistory.size() - 1));
        supervisorAgent.invoke(chatHistory);
        System.out.println(chatHistory.get(chatHistory.size() - 1));


        chatHistory.add(new UserMessage("yes please proceed with payment"));
        System.out.println(chatHistory.get(chatHistory.size() - 1));
        supervisorAgent.invoke(chatHistory);
        System.out.println(chatHistory.get(chatHistory.size() - 1));
    }
