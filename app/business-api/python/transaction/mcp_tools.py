...
def get_card_transactions(accountId: str, cardId: str):
    logger.info("getCardTransactions called with accountId=%s, cardId=%s", accountId, cardId)
    return service.get_transactions_by_type(account_id=accountId, card_id=cardId)
...
def get_last_transactions(accountId: str):
    ...
    return service.get_transactions(accountId)
